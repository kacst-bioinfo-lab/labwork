...
h=8.5
w=11
dev.copy(pdf, file="Figures/counts.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/covplot.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/tagHeatmap.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/peakHeatmap.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/plotAvgProf.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/plotAvgProf2.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/tagAvgProf.pdf", height=h, width=w);
dev.off();
#####
...
dev.copy(pdf, file="Figures/AnnoPie.pdf", height=h, width=w);
dev.off();


plot9<-vennpie(peakAnno)
print(plot9)
dev.copy(pdf, file="Figures/VennPie.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/AnnotBar.pdf", height=h, width=w);
dev.off();
...
dev.copy(pdf, file="Figures/upsetplot.pdf", height=h, width=w);
dev.off();
